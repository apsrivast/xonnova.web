 ...
 */
function pyxter_venta_telcel($e_COMPANIA, $e_TELEFONO, $e_MONTO)
{
  $e_TIMEOUT = 180;
...
function pyxter_solicitar_venta($e_COMPANIA, $e_TELEFONO, $e_MONTO)
{
  ...
  $e_URL = '?';
  $e_URL = 'http://ext.bluextreme.mx/index.php?ACTION=WEBSERVICE:LOAD_NUSOAP&NUSOAP=PYXTER:C5A.GTW.SHARED.WS_AVANZADO&wsdl';
  //Instancia asignada por el proveedor
  $e_INSTANCIA = 'BLUEXTREME_GTW1';
  ...
  $e_ENTIDAD_CONTRASENA = 'vqbCdtjHy9lneX484kOL';
