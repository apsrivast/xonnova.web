...
<head>
  ...
  <title>Onlegacy Network</title>
	...
	<script src="<?php echo base_url();?>/bower_components/jquery/dist/jquery.1.7.0.js"></script>
				...
				if(isset($tree) && !empty($tree)){
					foreach ($tree as $key => $value) {			
							...
							if(!empty($Rtree1) && !empty($right)){
												...
												foreach ($Rtree2 as $key => $value2) {
													echo '{
														...
														if(!empty($Ltree3) && !empty($left2)){
															...
															echo '{"id":"L'.$value2["user_id"].'","name":"Add User","parent_id":'.$value2["user_id"].',"level":0,"position_tree":"R","image":"0"},';
														}
														if(!empty($Rtree3) && !empty($right2)){
															foreach ($Rtree3 as $key => $value3) {
																echo '{
								...
								echo '{"id":"R'.$cur_user_id.'","name":"Add New User","parent_id":'.$cur_user_id.',"level":0,"position_tree":"R","image":"0"},';
							}	
							echo ']';
						echo '};';
					}
...
<div ng-include="'/Onlegacy/application/views/admin/views/templates/custom-styles.html'"></div>

<ng-include src="'/Onlegacy/application/views/admin/views/layout/header.html'"></ng-include>