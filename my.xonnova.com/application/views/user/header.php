...
<head>
  ...
  <title>Xonnova</title>
	...
	<link rel="stylesheet" href="<?php echo base_url();?>/assets/css/default.date.css"/>
  	<link rel="stylesheet" href="<?php echo base_url();?>/assets/css/mystyles/userstyle.css"/>
	...
	<script>
		...
		var CUR_USER_STATUS = "<?php echo $this->session->userdata('user_status'); ?>";
		...
		var CHEQUE_STATUS = "<?php echo  $this->session->userdata('is_cheque_status');?>";
		...
		<?php 
		 	...
		 	<?php 
			  $this->mdl_common->userMenu($this->session->userdata('user_id'));
			?>
